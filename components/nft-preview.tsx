...
export function NFTPreview({
  ...
  return (
    <div
      className={`w-full flex flex-col items-center rounded-md bg-gray-800 object-contain h-48 justify-between px-3 py-2 shadow relative border-2 ${selected ? "border-primary" : "border-transparent"
        }`}
