...
export function AccountsProvider({ children = null as any }) {
  ...
  const [manualPublicKeyString, setManualPublicKeyString] =
    useState<string>("");

  const [systemProgramAccountInfo, setSystemProgramAccountInfo] =
    useState<AccountInfo<Buffer> | null>(null);
  ...
  useEffect(() => {
    ...
    connection.getAccountInfo(userPublicKey).then((accountInfo) => {
