...
import { ValidatorScore, getValidatorScores } from "../util/validatorsApp";
...
export function ValidatorsProvider({ children = null as any }) {
  ...
  useEffect(() => {
    ...
    getValidatorScores(cluster).then(setValidatorScores);
  }, [connected, cluster]);
  ...
  useEffect(() => {
    ...
    getStakeviewApys().then(setValidatorApys);
  }, [cluster]);
