...
import { toUniformCreators } from '../../types/Creator.mjs';
...
const createCandyMachineBuilder = async (metaplex, params) => {
  ...
  const {
    ...
    creators: (_params$creators = params.creators) !== null && _params$creators !== void 0 ? _params$creators : toUniformCreators(metaplex.identity().publicKey),
