...
export declare const assertCandyMachine: (value: any) => asserts value is Readonly<{
    model: 'candyMachine';
    address: PublicKey;
    authorityAddress: PublicKey;
    walletAddress: PublicKey;
...
export declare const toCandyMachine: (account: CandyMachineAccount, unparsedAccount: UnparsedAccount) => CandyMachine;
