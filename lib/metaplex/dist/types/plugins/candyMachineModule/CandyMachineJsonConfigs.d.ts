import { Creator, DateTimeString, PublicKeyString } from "../../types";
 ...
 * ```
 */
export declare type CandyMachineJsonConfigs = {
    price: number;
    number: number;
 ...
 */
declare type GatekeeperSettingsConfig = {
 ...
 * is complete
 */
declare type HiddenSettingsConfig = {
    name: string;
    uri: string;
    hash: string;
};
 ...
 * */
declare type EndSettingsConfig = {
    endSettingType: 'date';
    value: string;
} | {
 ...
 */
declare type WhitelistMode = 'burnEveryTime' | 'neverBurn';
/**
 ...
 */
declare type WhitelistMintSettingsConfig = {
    mode: WhitelistMode;
    mint: PublicKeyString;
    presale: boolean;
    discountPrice: number;
};
declare type CreatorConfig = Omit<Creator, 'address'> & {
    address: PublicKeyString;
};
export declare const toCandyMachineConfigsFromJson: (config: CandyMachineJsonConfigs) => CandyMachineConfigs;
export {};
